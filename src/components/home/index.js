...
const Home = () => {
    ...
    return ( < div className = "container" >
        ...
        /h2> <
        p className = "text text-center" > Merit based work commons
        for builders and communities < /p> <
        p className = "text text-center" > Building a Culture of Reputation Wealth and The Next Working Commons < br / > < br / > < br / > < /p>

        <
        h2 className = "subtitle text-center" >
        Rewards system that incentivizes coders to make small shifts in already proven code <
        /h2> <
        p className = "text text-center" > Easily adapt applications quickly to new communities < /p> <
        p className = "text text-center" > Allowing coders to earn reputation
        for their contributions < br / > < br / > < br / > < br / > < /p>

        <
        h2 className = "subtitle text-center" >
        Driving down the time and cost of app development <
        /h2> <
        p className = "text text-center" > Providing coders and builders the opportunity to construct their professional reputation and earn scalable wealth. < /p>
